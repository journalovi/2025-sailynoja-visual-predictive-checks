...
![Histogram](images/intro_histogram.png){#fig-intro-triplet-histogram fig-alt="A histogram with 30 equally spaced bins showing a sample from normal distribution."}

![KDE Density plot](images/intro_density.png){#fig-intro-triplet-kde fig-alt="A kernel density plot of a sample from normal distribution."}

![Quantile dot plot](images/intro_qdot.png){#fig-intro-triplet-qdot fig-alt="A quantile dot plot of a sample from normal distribution. The plot shows 100 vertically stacked dots at the x-axis positions of their respective quantiles."}
