...
::: {.callout-important appearance="simple" icon=false collapse=false}

This article is intended to be viewed as an HTML, and its latest version is hosted online [here](https://teemusailynoja.github.io/visual-predictive-checks). 
